        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              ...
              <span class="menu-title">Therapy Sessions</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
              <!-- <li class="nav-item"><a class="nav-link" href="">Schedule</a></li> -->
                <li class="nav-item"><a class="nav-link" href="{{route('therapysessions')}}">View</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
              <!-- <li class="nav-item"><a class="nav-link" href="">Schedule</a></li> -->
                <li class="nav-item"><a class="nav-link" href="{{route('therapistprofile')}}">Profile</a></li>
              </ul>
            </div>
          </li>
